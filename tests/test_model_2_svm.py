...
def test_model_2_svm_uses_explicit_calibration():
    estimator = create_model(random_seed=42, calibrated=True, calibration_cv=3)
...
def test_model_2_svm_fit_has_no_probability_futurewarning():
    estimator = create_model(random_seed=42, calibrated=False)
    x = np.array([[0.0, 0.0], [0.1, 0.2], [1.0, 1.0], [1.2, 0.9], [0.2, 0.1], [0.9, 1.1]])
